...
**Email:** [support@getcarpediem.app](mailto:support@getcarpediem.app)

Please include:

- Your **device** (e.g. iPhone 15, Pixel 9)
- Your **OS version**
- **App version** (Settings in the app, or the listing in your store)
- What you **expected** vs what **happened**
- If it’s urgent, mention **privacy** sensitivity in the subject line if relevant

We typically reply from the same inbox; allow a little time for backlog and timezone differences.
...
Want a fuller picture of what the app is for? See [Marketing](marketing.md).
